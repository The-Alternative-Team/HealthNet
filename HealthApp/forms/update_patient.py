...
class UpdatePatient(forms.ModelForm):
    def __init__(self, patient=None, postData=None):
        ...
        self.fields['home_phone'].widget.attrs = {'class': 'form-control', 'placeholder': '(123)456-7890'}
        self.fields['cell_phone'].widget.attrs = {'class': 'form-control', 'placeholder': '(123)456-7890'}
        ...
        self.fields['e_cont_home_phone'].widget.attrs = {'class': 'form-control', 'placeholder': '(123)456-7890'}
        self.fields['e_cont_home_phone'].label = 'Emergency Contact: Home Phone Number'
        self.fields['e_cont_cell_phone'].widget.attrs = {'class': 'form-control', 'placeholder': '(123)456-7890'}
